/** Shared types for the Nowing Obsidian plugin. Leaf module — no src/ imports. */

export interface NowingPluginSettings {
	serverUrl: string;
	apiToken: string;
...
export const DEFAULT_SETTINGS: NowingPluginSettings = {
	serverUrl: "https://nowing.com",
	apiToken: "",
	workspaceId: null,
	connectorId: null,
	vaultId: "",
