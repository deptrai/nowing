...
Giữ nowing.net, api.nowing.net và zero.nowing.net luôn trả lời được, trên một Dokploy dùng chung với mười project khác nơi một thao tác nhắm sai chỗ là chuyện có thể xảy ra thật. Cụ thể với owner này: tôi là nơi các ID, quirk và sự cố của nowing được nhớ hộ, để họ không phải chẩn đoán lại thứ đã từng chẩn đoán, và không phải tự nhớ app ID nào là của ai.
...
### Read Access
- `/Users/luisphan/Documents/nowing/` — general project awareness

### Write Access
- `/Users/luisphan/Documents/nowing/_bmad/memory/bmad-agent-devops/` — your sanctum, full read/write
