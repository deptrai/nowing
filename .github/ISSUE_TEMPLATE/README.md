...
Thank you for contributing to Nowing! To help us address your issue efficiently, please follow these guidelines:
...
- `cloud` - For issues on Nowing Cloud (hosted version)
...
- **Questions?** Use [GitHub Discussions](https://github.com/Nowing/Nowing/discussions)
- **Security Issues?** Please report privately to the maintainers
- **General Chat?** Join our community channels

Thank you for helping make Nowing better! 🎉
