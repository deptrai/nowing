...
const STEPS = [
	{
		...
		description:
			"Lets Nowing capture your screen to understand context and provide smart writing suggestions.",
	...
	},
	{
		id: "accessibility",
		title: "Accessibility",
		description: "Lets Nowing insert suggestions seamlessly, right where you\u2019re typing.",
				...
				<div className="text-center space-y-3 shrink-0">
					...
					<div className="space-y-1">
						...
						<p className="text-sm text-muted-foreground">
							Nowing needs two macOS permissions to provide context-aware writing suggestions.
						</p>
					</div>
				</div>
