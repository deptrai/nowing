...
export async function generateMetadata(props: {
	...
	return {
		title: `${page.data.title} | Nowing Blog`,
		description: page.data.description,
		alternates: {
			canonical: `https://www.nowing.com/blog/${slug}`,
		},
		openGraph: {
			...
			authors: [page.data.author ?? "Nowing Team"],
			tags: page.data.tags,
	...
	return (
		<div className="min-h-screen relative pt-20">
			<ArticleJsonLd
				title={page.data.title}
				description={page.data.description}
				url={`https://www.nowing.com/blog/${slug}`}
				datePublished={page.data.date}
				dateModified={dateModified}
				author={page.data.author ?? "Nowing Team"}
				image={page.data.image ? `https://www.nowing.com${page.data.image}` : undefined}
			/>
					...
					<div className="flex items-center gap-3 text-sm text-muted-foreground">
						{page.data.authorAvatar && (
							<Image
								...
								alt={page.data.author ?? "Nowing Team"}
								width={32}
								height={32}
