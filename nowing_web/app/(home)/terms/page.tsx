...
export default function TermsOfService() {
	return (
		<div className="container max-w-4xl mx-auto py-12 px-4">
			<h1 className="font-serif text-3xl sm:text-4xl font-normal mb-6">Terms of Service</h1>
			...
			<div className="prose dark:prose-invert max-w-none">
				...
				<section className="mb-8">
					...
					<p>
						...
						when you use our Services. By using our Services, you agree that Nowing can use such
				...
				<section className="mb-8">
					...
					<p className="mt-4">
						...
						software—is the property of Nowing or its content suppliers and is protected by
				...
				<section className="mb-8">
					...
					<p className="mt-4 uppercase font-bold">
						IN ALL CASES, NOWING, AND ITS SUPPLIERS AND DISTRIBUTORS, WILL NOT BE LIABLE FOR ANY
				...
				<section className="mb-8">
					...
					<p>
						You agree to defend, indemnify, and hold harmless Nowing, its affiliates, and their
				...
				<section className="mb-8">
					...
					<p className="mt-4">
						...
						Nowing and you. They do not create any third-party beneficiary rights.
					</p>
					<p className="mt-4">
