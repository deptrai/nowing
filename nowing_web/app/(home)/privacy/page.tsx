...
export default function PrivacyPolicy() {
	return (
		<div className="container max-w-4xl mx-auto py-12 px-4">
			<h1 className="font-serif text-3xl sm:text-4xl font-normal mb-6">Privacy Policy</h1>
			...
			<div className="prose dark:prose-invert max-w-none">
				...
				<section className="mb-8">
					...
					<p>
						Welcome to Nowing ("Nowing", "we", "us", or "our"). We operate the website at{" "}
						<a href="https://www.nowing.com">www.nowing.com</a> and the Nowing application
				...
				<section className="mb-8">
					...
					<p>
						Our free public pages (currently <Link href="/free">www.nowing.com/free</Link>) are
