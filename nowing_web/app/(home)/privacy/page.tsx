...
export const metadata: Metadata = {
	...
	description: "Privacy Policy for Nowing application",
	alternates: {
		canonical: "https://nowing.com/privacy",
	},
};
		...
		<div className="container max-w-4xl mx-auto py-12 px-4">
			...
			<div className="prose dark:prose-invert max-w-none">
				...
				<section className="mb-8">
					...
					<p>
						Welcome to Nowing. We respect your privacy and are committed to protecting your
