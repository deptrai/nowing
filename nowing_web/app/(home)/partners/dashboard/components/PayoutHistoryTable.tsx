				...
				<div className="overflow-x-auto">
					<table className="w-full text-left text-sm">
						<thead className="bg-neutral-50 dark:bg-neutral-800/50 text-xs text-neutral-500 uppercase font-semibold">
							<tr>
								<th className="px-6 py-3.5">{t("requested_date")}</th>
								<th className="px-6 py-3.5">{t("gross_amount")}</th>
								<th className="px-6 py-3.5">{t("pit_tax")}</th>
								<th className="px-6 py-3.5">{t("net_received")}</th>
								<th className="px-6 py-3.5">{t("method")}</th>
								<th className="px-6 py-3.5">{t("status")}</th>
								<th className="px-6 py-3.5">{t("napas_ref")}</th>
						...
						<div className="space-y-4 py-3 text-sm">
							<div className="p-4 rounded-2xl bg-neutral-50 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700 space-y-2.5">
								<div className="flex justify-between">
									<span className="text-neutral-500">{t("transaction_id")}</span>
									<span className="font-mono font-bold text-xs">{selectedReceipt.id}</span>
								</div>
								<div className="flex justify-between">
									<span className="text-neutral-500">{t("napas_reference")}</span>
									<span className="font-mono font-bold text-emerald-600">
										{selectedReceipt.napas_ref || "N/A"}
									</span>
								</div>
								<div className="flex justify-between">
									<span className="text-neutral-500">{t("gross_payout")}</span>
								...
								<div className="flex justify-between">
									<span className="text-neutral-500">{t("pit_tax_withheld")}</span>
								...
								<div className="space-y-1">
									...
									<div className="p-2.5 rounded-xl bg-neutral-100 dark:bg-neutral-800 text-[11px] font-mono text-neutral-700 dark:text-neutral-300 break-all select-all flex items-center justify-between gap-2">
										...
										<button
											type="button"
											onClick={() =>
												handleCopy(selectedReceipt.hmac_audit_hash || "", t("audit_seal_label"))
											}
