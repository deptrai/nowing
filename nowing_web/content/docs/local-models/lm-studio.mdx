---
title: LM Studio
description: Connect LM Studio to Nowing
---
...
Use this when Nowing is running from Docker and LM Studio is running on your computer.
...
Use this when Nowing and LM Studio both run directly on the same computer.
...
Nowing discovers models from `/v1/models`. If you enter the URL without `/v1`, Nowing adds it for requests.
...
Load a model in LM Studio, then refresh model discovery in Nowing.
