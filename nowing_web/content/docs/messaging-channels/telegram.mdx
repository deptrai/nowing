...
Telegram lets users chat with the Nowing agent from a Telegram bot. Users pair
...
3. Nowing provides a pairing code or bot link.
4. The user sends the pairing command to the Telegram bot.
5. Nowing binds that Telegram chat to the selected workspace.
