...
This guide walks you through setting up an Atlassian OAuth 2.0 (3LO) integration for Nowing to connect your Confluence spaces.
...
## Running Nowing with Confluence Connector

Add the Atlassian credentials to your environment configuration:
