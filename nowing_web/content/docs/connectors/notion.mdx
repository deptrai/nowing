...
This guide walks you through setting up a Notion OAuth integration for Nowing.
...
Notion's API has limitations on certain block types that cannot be retrieved. Nowing will automatically skip these unsupported blocks and continue syncing all other content.
...
## Running Nowing with Notion Connector

Add the Notion credentials to your environment configuration:
