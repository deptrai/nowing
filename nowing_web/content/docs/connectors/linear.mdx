...
This guide walks you through setting up a Linear OAuth integration for Nowing.
...
| **Application name** | `Nowing` |
| **Developer name** | `Nowing` |
| **Developer URL** | `https://www.nowing.com/` |
...
## Running Nowing with Linear Connector

Add the Linear credentials to your environment configuration:
