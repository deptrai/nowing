---
title: Connectors
description: Connect Nowing to your tools and services
---

import { Card, Cards } from 'fumadocs-ui/components/card';
import { Zap, Cable } from 'lucide-react';

Connectors bring data into Nowing — either as searchable knowledge or as live tools the AI agent can use during chat. There are two kinds:

<Cards>
  <Card
    icon={<Zap />}
    title="Native Connectors"
    description="Nowing's built-in scraper APIs: Reddit, YouTube, Instagram, TikTok, Amazon, Google Maps, Google Search, and Web Crawl — usable in chat, the API Playground, or via REST"
...
## How connectors surface in Nowing
...
- **Tools & Live Sources** — external connectors like Notion, Slack, Jira, or Linear give the agent real-time tools. Ask a question in chat and the agent searches or acts on the connected service directly; nothing is copied into Nowing in the background.
