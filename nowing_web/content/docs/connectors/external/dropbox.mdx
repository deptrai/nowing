---
title: Dropbox
description: Import your Dropbox files into the Nowing knowledge base
---
...
<Callout type="info">
This setup is only needed on **self-hosted** deployments. On Nowing Cloud, just use **Import → Dropbox**.
</Callout>
...
| **Name your app** | `Nowing` (or any unique name) |
...
Restart Nowing, open **Documents → Import → Dropbox**, and authorize:
