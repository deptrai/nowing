...
This guide walks you through setting up a Slack OAuth integration for Nowing.
...
## Running Nowing with Slack Connector

Add the Slack credentials to your environment configuration:
