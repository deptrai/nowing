...
response = requests.post(
    "${url}",
    headers={"Authorization": f"Bearer {os.environ['NOWING_API_KEY']}"},
    json=${indent(body, 4)},
)
...
client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(
    "Bearer", Environment.GetEnvironmentVariable("NOWING_API_KEY"));
...
request["Authorization"] = "Bearer #{ENV["NOWING_API_KEY"]}"
