...
export const googleSearch: ConnectorPageContent = {
	...
	metaTitle: "SERP API for Rank Tracking and AI Overview Monitoring | Nowing",
	metaDescription:
		"Track rankings, ads, and Google AI Overviews with the Nowing SERP API. Scrape Google Search results as structured JSON via API or MCP. Start free.",
	keywords: [
		"serp api",
	...
	heroLede:
		"The Nowing SERP API scrapes Google Search results as structured JSON: organic rankings, paid ads, AI Overviews, and People Also Ask. Point your AI agents at the queries you care about and know the moment a rank moves, an ad appears, or an AI answer changes its sources.",
	...
	comparison: {
		...
		intro:
			"Most SERP APIs bill per search, gate AI Overviews behind add-ons, and leave the rank-tracking logic to you. Here is how Nowing compares.",
		columnLabel: "Typical SERP API",
		rows: [
			{
				feature: "Pricing",
				official: "Per-search pricing that climbs fast at scale",
				nowing: "Pay per SERP page returned, with a free tier to start",
			},
			{
				feature: "AI Overviews",
				official: "Often a paid add-on, or not supported at all",
				nowing: "Parsed inline with the answer text and the sources it cites",
			},
			{
				feature: "Rank tracking",
				official: "You build the diffing and alerting yourself",
				nowing: "Structured positions your agent can diff and alert on",
			},
			{
				feature: "Setup",
			...
			},
			{
				...
				nowing: "MCP server exposes google_search.scrape as a native tool",
			},
		],
	},
	...
	faq: [
		{
			...
			answer:
				"A SERP API returns the contents of a search engine results page as structured data instead of raw HTML. The Nowing SERP API scrapes Google Search and gives you organic results, ads, AI Overviews, and People Also Ask as clean JSON your agents can read.",
		},
		{
