...
export const tiktok: ConnectorPageContent = {
	...
	metaTitle: "TikTok API for Videos, Comments, and Trends | Nowing",
	metaDescription:
	...
	heroLede:
		"The Nowing TikTok scraper extracts public videos by hashtag, creator profile, or URL, plus comment threads and trending feeds, without TikTok's approval-gated Research API. Give your AI agents a live feed of what people watch and share, so you catch a trend while it is still rising.",
	...
	comparison: {
		...
		intro:
			"TikTok's official Research API is approval-gated and largely limited to academic and nonprofit use. If you cannot get access or need commercial TikTok scraping, Nowing is a TikTok API alternative. Here is how it compares.",
		columnLabel: "Official TikTok API",
		rows: [
			{
				feature: "Access",
				official: "Application and approval, often restricted to academic/nonprofit use",
				nowing: "One API key, no approval process",
			},
			{
				feature: "Pricing",
			...
			},
			{
				...
				nowing: "Handled for you; a real browser signs each request",
			},
			{
				feature: "Setup",
			...
			},
			{
				...
				nowing: "MCP server exposes scrape, comments, user search, and trending as native tools",
			},
		],
	},
	...
	faq: [
		{
			...
			answer:
				"Nowing reads only public TikTok data, the same videos any logged-out visitor can see. It never logs in and cannot access private or deleted content. As always, review TikTok's terms and your own compliance needs before you run at scale.",
		},
		{
			question: "Does this need the official TikTok Research API?",
			answer:
				"No. This TikTok scraper API is an independent alternative, not a wrapper on the Research API, so there is no application or approval process. You call Nowing with one key, or add the MCP server to your agent, and get structured videos, comments, and profile data back.",
		},
		{
		...
		},
		{
			...
			answer:
				"Each call caps at 100 returned videos across all sources, with up to 20 hashtags, profiles, or URLs per request. Nowing manages the underlying request budget and request signing for you.",
		},
		{
