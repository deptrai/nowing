...
export const googleMaps: ConnectorPageContent = {
	...
	metaTitle: "Google Maps Scraper API for Lead Generation | Nowing",
	metaDescription:
		"Turn Google Maps into a B2B lead engine with the Nowing Google Maps Scraper API. Extract business data, ratings, and reviews at scale for your AI agents. Start now.",
	keywords: [
		"google maps scraper",
	...
	heroLede:
		"The Nowing Google Maps API turns Maps into a B2B lead engine. Extract business names, categories, phones, websites, ratings, and reviews at scale, then point your AI agents at any territory or category to build lead lists and map any local category in minutes.",
	...
	comparison: {
		...
		intro:
			"Google's official Places API is metered per call and returns only a handful of reviews. Here is how Nowing compares for lead generation and market research.",
		columnLabel: "Official Places API",
		rows: [
			{
				feature: "Results per query",
				official: "Paginated and capped; bulk pulls are painful",
				nowing: "Up to 1,000 places per search query",
			},
			{
				feature: "Reviews",
				official: "Only about five reviews per place",
				nowing: "Attach up to the review count you set, or use the reviews verb for depth",
			},
			{
				feature: "Pricing",
				official: "Metered per API call, per field mask",
				nowing: "Pay per place returned, with a free tier to start",
			},
			{
				feature: "Setup",
			...
			},
			{
				...
				nowing: "MCP server exposes google_maps.scrape as a native tool",
			},
		],
	},
	...
	faq: [
		{
			...
			answer:
				"Nowing reads only public Google Maps listings, the business data any visitor can see. It collects no private data and cannot access anything behind a login. Review Google's terms and your own compliance needs, especially around personal data in reviews, before running at scale.",
		},
		{
		...
		},
		{
			...
			answer:
				"The Places API is metered per call and returns only about five reviews per place. Nowing returns up to 1,000 places per query with deeper reviews, no Cloud project to set up, and an MCP server so your agents can call it as a native tool.",
		},
	],
