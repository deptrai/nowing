...
export const youtube: ConnectorPageContent = {
	...
	metaTitle: "YouTube Data API for Comments and Transcripts | Nowing",
	metaDescription:
		"Scrape YouTube videos, comments, and transcripts at scale with the Nowing YouTube Scraper API. No Data API quotas, plus a free tier for AI agents. Start now.",
	keywords: [
		"youtube scraper",
		"youtube scraper api",
	...
	heroLede:
		"The Nowing YouTube API pulls videos, channel stats, comments, and transcripts at scale, without YouTube Data API quotas. Feed your AI agents every comment and transcript that matters to your research, so you know what audiences actually think about any product, topic, or channel.",
	...
	comparison: {
		...
		intro:
			"The official YouTube Data API gives you 10,000 units a day, and reading comments burns through it fast. Here is how Nowing compares.",
		columnLabel: "YouTube Data API",
		rows: [
			{
				feature: "Quota",
				official: "10,000 units per day; comment reads drain it fast",
				nowing: "No daily unit quota; pay per item returned",
			},
			{
				feature: "Comments",
				official: "Paginated and quota-heavy at depth",
				nowing: "Up to 100,000 comments and replies per video",
			},
			{
				feature: "Transcripts",
				official: "Not available through the official API",
				nowing: "Subtitle tracks included, in the language you pick",
			},
			{
				feature: "Setup",
			...
			},
			{
				...
				nowing: "MCP server exposes youtube.scrape as a native tool",
			},
		],
	},
	...
	faq: [
		{
			...
			answer:
				"Nowing reads only public YouTube data, the videos, channels, and comments any visitor can see. It never signs in and cannot access private or unlisted content. Review YouTube's terms and your own compliance needs before running large jobs.",
		},
		{
