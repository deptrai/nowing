...
export const amazon: ConnectorPageContent = {
	...
	metaTitle: "Amazon Product API for Price and Review Data | Nowing",
	metaDescription:
	...
	comparison: {
		...
		intro:
			"Most Amazon data APIs bill per request, meter add-ons separately, and leave the discovery-to-detail logic to you. Here is how Nowing compares.",
		columnLabel: "Typical Amazon data API",
		rows: [
			{
				feature: "Pricing",
				official: "Per-request pricing that climbs fast at scale",
				nowing: "Pay per product returned, with a free tier to start",
			},
			{
				feature: "Discovery",
				official: "Separate search and detail endpoints you stitch together",
				nowing: "One verb takes search terms, product, category, or best-seller URLs",
			},
			{
				feature: "Offers & sellers",
				official: "Often separate paid endpoints",
				nowing: "Offers and seller profiles enriched inline on the product",
			},
			{
				feature: "Data access",
				official: "Requires accounts, keys, or approval for many providers",
				nowing: "Public, anonymous data only — no login or seller account",
			},
			{
				feature: "Agent-ready",
				official: "No; you wire the harness yourself",
				nowing: "MCP server exposes amazon.scrape as a native tool",
			},
		],
	},
	...
	faq: [
		{
			...
			answer:
				"An Amazon product API returns a listing's data as structured JSON instead of raw HTML. The Nowing Amazon API scrapes public product pages and gives you price, rating, review breakdown, offers, sellers, and best-seller ranks as clean JSON your agents can read.",
		},
		{
		...
		},
		{
			...
			answer:
				"Marketplace routing is inferred from the Amazon URL or domain. Nowing supports public Amazon data from US, UK, Germany, Italy, and Spain. France is wired in and retried like the others, but remains best-effort because Amazon France is more sensitive to proxy-pool WAF challenges.",
		},
	],
