...
export const instagram: ConnectorPageContent = {
	...
	metaTitle: "Instagram API for Profiles, Posts, and Reels | Nowing",
	metaDescription:
	...
	heroLede:
		"The Nowing Instagram scraper extracts public profiles, posts, and reels without logging in or registering for the Instagram Graph API. Give your AI agents a live feed of what creators post, so you spot trends and shifts in engagement first.",
	...
	comparison: {
		...
		intro:
			"The official Instagram Graph API requires a Business account, app review, and access tokens, and it cannot read arbitrary public profiles. Nowing is an Instagram API alternative for public data. Here is how it compares.",
		columnLabel: "Instagram Graph API",
		rows: [
			{
				feature: "Access",
				official: "Business/Creator account + app review + tokens",
				nowing: "Public data only, no login or account required",
			},
			{
				feature: "Coverage",
				official: "Mostly your own or connected accounts",
				nowing: "Any public profile, post, or reel",
			},
			{
				feature: "Setup",
				official: "Register an app, pass review, manage tokens",
				nowing: "One API key, or add the MCP server to your agent",
			},
			{
				feature: "Agent-ready",
				official: "No; you build the harness yourself",
				nowing: "MCP server exposes instagram.scrape as a native tool",
			},
		],
	},
	...
	faq: [
		{
			...
			answer:
				"Nowing reads only public Instagram data, the same posts, reels, and profiles any logged-out visitor can see. It never logs in and cannot access private accounts, stories, or login-walled feeds. As always, review Instagram's terms and your own compliance needs before you run at scale.",
		},
		{
			question: "Do I need an Instagram account or the Graph API?",
			answer:
				"No. This Instagram scraper API is an independent alternative to the Instagram Graph API, not a wrapper. You do not create a Business account, pass app review, or manage access tokens. You call Nowing with one key, or add the MCP server to your agent, and get structured profile, post, and reel data back.",
		},
		{
		...
		},
		{
			...
			answer:
				"Each call caps at 100 returned items across all sources, with up to 20 URLs or search queries per request. Nowing manages the underlying request budget and proxy rotation for you, so you scale reads without managing tokens.",
		},
		{
			question: "Can I scrape hashtags, places, or comments?",
			answer:
				"No. Instagram login-walls hashtag feeds, place feeds, and comment threads for logged-out visitors, so Nowing does not offer them. You still get each post's comment count, just not the comment text. The API focuses on what is reliably public and anonymous: profiles, posts, and reels.",
		},
	],
