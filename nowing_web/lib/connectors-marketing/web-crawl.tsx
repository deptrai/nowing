...
export const webCrawl: ConnectorPageContent = {
	...
	metaTitle: "Web Scraping and Crawl API for AI Agents | Nowing",
	metaDescription:
		"Point your agents at any URL and get clean, LLM-ready markdown, links, and contacts back. The Nowing Web Crawl API for deep research and site monitoring. Start free.",
	keywords: [
		"web crawl api",
		"web scraping api",
		"web crawler api",
	...
	heroLede:
		"The Nowing Web Crawl API points your AI agents at any URL and returns clean, LLM-ready markdown, structured links, and harvested contacts. Scrape a single page or spider a whole site, with the same agent harness that powers our platform connectors.",
	...
	comparison: {
		...
		intro:
			"Commodity crawlers hand you markdown and leave the rest to you. Nowing adds the harness, the contact extraction, and the platform connectors around it.",
		columnLabel: "Commodity crawler",
		rows: [
			{
				feature: "Output",
				official: "Markdown or HTML you post-process yourself",
				nowing: "Markdown plus parsed links, contacts, and site-wide roll-ups",
			},
			{
				feature: "Contacts",
				official: "Not extracted; you write the regex",
				nowing: "Emails, phones, and socials harvested with page provenance",
			},
			{
				feature: "Scope",
				official: "One site at a time",
				nowing: "Crawl the open web, then combine with platform connectors in one workflow",
			},
			{
				feature: "Pricing",
				official: "Per-page credits that add up quickly",
				nowing: "Pay per successful page, with a free tier to start",
			},
			{
				feature: "Agent-ready",
				official: "An SDK you wire into your own harness",
				nowing: "MCP server exposes web.crawl as a native tool",
			},
		],
	},
	...
	faq: [
		...
		},
		{
			...
			answer:
				"You get more than markdown: parsed links, harvested contacts with provenance, and an MCP server that exposes web.crawl as a native agent tool. It shares one harness and workspace with the Nowing platform connectors, so a crawl and a Reddit or Maps pull live in the same workflow.",
		},
	],
