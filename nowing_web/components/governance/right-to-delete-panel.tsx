...
export function RightToDeletePanel({
	workspaceId,
	canEdit,
	className,
}: RightToDeletePanelProps) {
	...
	}, [mode, memoryId, sourceType, sourceId, createdBefore, createdAfter, reason, t]);
					...
					{mode === "single" ? (
						...
						<div className="space-y-4">
							...
							<div className="grid gap-4 sm:grid-cols-2">
								<div className="space-y-2">
									<Label htmlFor="rtd-created-after">
										{t("right_to_delete.created_after")}
									</Label>
									<Input
								...
								<div className="space-y-2">
									<Label htmlFor="rtd-created-before">
										{t("right_to_delete.created_before")}
									</Label>
									<Input
						...
						<div className="rounded-md border p-4 space-y-2">
							<div className="flex items-center gap-2">
								...
								<h4 className="text-sm font-medium">
									{t("right_to_delete.dry_run_result")}
								</h4>
							</div>
							<p className="text-sm">
