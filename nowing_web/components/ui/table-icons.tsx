...
export function BorderBottomIcon(props: LucideProps) {
	const t = useTranslations("ui");	return (
		<svg
			...
			{...props}
		>
			<title>{t("ui_border_bottom")}</title>
			<path
				clipRule="evenodd"
