...
export function DataRetentionManager({
	...
	useEffect(() => {
		if (workspace) {
			...
			setAction(
				(workspace.document_retention_action as "archive" | "delete") ?? "archive"
			);
		}
	}, [workspace]);
	...
	return (
		<form
			onSubmit={handleSave}
			role="region"
			aria-label={t("data_retention_title")}
		...
		>
			...
			<div className="flex justify-end">
				<Button type="submit" disabled={!hasChanges || saving || !isOwner} data-testid="data-retention-save-button">
