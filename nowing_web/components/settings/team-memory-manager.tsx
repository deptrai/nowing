		...
		return (
			<div className="flex flex-col items-center justify-center py-16 text-center">
				<h3 className="text-base font-medium text-foreground">
					What does Nowing remember about your team?
				</h3>
				<p className="mt-2 max-w-sm text-sm text-muted-foreground">
					Nothing yet. Nowing picks up on team decisions and conventions as your team chats.
				</p>
			</div>
		);
	}
		...
		<div className="space-y-4">
			<Alert className="bg-muted/50 py-3 md:py-4">
				...
				<AlertDescription className="text-xs md:text-sm">
					<p>
						Nowing uses this shared memory to provide team-wide context across all conversations
					...
					<div className="absolute bottom-3 inset-x-3 z-10">
						...
						>
							<input
								...
								placeholder="Tell Nowing what to remember or forget about your team"
								disabled={editing}
