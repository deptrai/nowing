...
- **PDF Preview Experience**: A built-in PDF viewer lets users preview generated resumes directly in Nowing before exporting.
...
- **SEO Metadata Refresh**: Titles and descriptions across key pages now better communicate Nowing's open-source, privacy-focused positioning.
...
v0.0.19 expands Nowing beyond search and chat into deliverable creation. With the new **AI resume builder**, PDF previews, stronger anonymous chat behavior, and desktop startup controls, Nowing becomes more useful both in the browser and as a daily desktop companion.
