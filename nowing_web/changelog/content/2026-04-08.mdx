...
This release continues to push Nowing as a fully self-hostable, open-core AI chat and research memory platform for teams who care about where their data lives. v0.0.15 is all about **bringing your local files into the knowledge base effortlessly** and making the Nowing desktop app a first-class always-on assistant.

### Watch Local Folder

Your files already live in folders. Now Nowing can watch them.

- **Real-Time Folder Sync**: Pick any folder on your computer, and Nowing automatically keeps it indexed as files are added, edited, or removed.
...
- **Smart Batching**: Many files at once? Nowing now processes them in smart batches with progress feedback, so large folders stay responsive.
...
We've rebuilt how Nowing turns raw files into searchable knowledge.
...
- **Audio Transcription**: Upload audio files and Nowing will transcribe them for you.
...
The Nowing desktop app becomes a serious always-on **AI like ChatGPT** that actually sees your screen, without leaving your current window.

- **Screenshot-Based Autocomplete**: Press a shortcut and Nowing captures a screenshot, sends it to a vision model, and returns context-aware suggestions right where you're typing.
...
- **Per-User Page Limits**: Nowing now estimates and enforces per-user page limits before indexing begins, so usage stays predictable on cloud and self-hosted deployments.
...
If you've been looking for a tool that works across your cloud connectors **and** your local machine, v0.0.15 is exactly that. It's also one of the most compelling **open-core research memory** and **free AI chat** options for private team use, with full control over your data, your parsers, and your models.
