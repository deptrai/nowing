...
For the past couple of months we set out to build the best general research agent for your own knowledge. That chapter treated us well. As the open-source alternative to NotebookLM, Nowing earned a community we are genuinely proud of: more than 15,000 GitHub stars, self-hosted deployments everywhere from homelabs to enterprises, and users who pushed the product further than we imagined.
