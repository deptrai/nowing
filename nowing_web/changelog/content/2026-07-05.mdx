...
## Nowing's Next Chapter: Open Web Research for AI Agents
...
Today we are pointing Nowing at a single mission: **give your AI agents the primitives to research the open web.**

### How we got here

For the past couple of months we set out to build the best general research agent for your own knowledge. That chapter treated us well. As an open-core research memory platform, Nowing earned a community we are genuinely proud of: more than 15,000 GitHub stars, self-hosted deployments everywhere from homelabs to enterprises, and users who pushed the product further than we imagined.
...
This is an addition, not a replacement. Your knowledge base, chat with citations, reports, podcasts, presentations, automations, and collaborative chats all keep working exactly as they do today. You can still upload files and sync Google Drive, OneDrive, and Dropbox. Self-hosting stays free and open-core, and your existing deployments keep running without any action from you. What changes is where we invest: expect deeper connectors, sharper agent workflows, and broader coverage of the open web.

If you are building agents, [grab an API key](/login) or add the MCP server, and start with the [connector catalog](/connectors). Tell us what you are building on [Discord](https://discord.gg/ejRNvftDp9) or [GitHub](https://github.com/nowing/Nowing).
