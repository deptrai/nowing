...
- **E2E Test Suite**: Nowing now includes an end-to-end test suite for critical product flows.
...
v0.0.24 makes multi-agent Nowing easier to trust and easier to follow. With a clearer UI, live subagent streaming, parallel approvals, and a real E2E safety net, this release turns the multi-agent runtime into a more visible and dependable part of everyday knowledge work.
