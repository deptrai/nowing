...
- **Improved Memory Extraction**: Nowing extracts durable memory more cleanly, keeping useful context while avoiding unnecessary noise.
...
v0.0.25 makes Nowing agents more efficient and easier to inspect. Faster turns, lower LLM cost, better citations, and more direct memory editing all move Nowing toward a smoother day-to-day AI knowledge workspace.
