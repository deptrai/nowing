...
If you've ever wanted to try **free AI chat online** or a **free AI chatbot** without creating an account, v0.0.16 is for you. This release makes Nowing instantly accessible with a **no-login** online experience, adds durable long-term memory for users and teams, brings full token-usage visibility to every chat, introduces AI file sorting, and ships a brand-new knowledge base export feature. It turns Nowing into an even more practical **free AI chat** for real knowledge work.

### No-Login Online Experience

- **Free AI Chat, No Login Required**: Try Nowing online for free without signing up. First-time visitors can chat and test the **free AI chat** experience instantly, with free tokens included.
...
Nowing agents now actually **remember**.

- **Personal & Team Memory**: Nowing can now remember durable information about you and your team across chats, stored cleanly as markdown you can read and edit yourself.
...
- **Usage Per Call**: Nowing now tracks how many tokens every AI call uses.
...
> **Note (2026-07-25):** This feature was shipped in v0.0.16 but later removed in migration `172_remove_ai_file_sort.py`. It is kept here as a historical changelog entry only.
...
- **Processing Warning**: Nowing warns you if documents are still processing, so you never ship an incomplete archive.
...
- **New Blog Section**: Added a dedicated blog section to the marketing site for deeper guides on **free AI chat tools**, **Claude AI**, and **open-core research memory**.
- **Improved SEO Metadata**: Updated metadata across key pages to emphasize privacy, data limits, and open-core positioning.
...
v0.0.16 makes Nowing the easiest open-core AI assistant to actually try: zero friction, no login, online. Whether you're searching for **free AI chat online**, **free Claude AI chat**, or an **open-core research memory** you can self-host, Nowing v0.0.16 is built for you.
