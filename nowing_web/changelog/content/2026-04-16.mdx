...
If you've ever wanted to try an **online ChatGPT alternative** or a **free AI chatbot like ChatGPT** without creating an account, v0.0.16 is for you. This release makes Nowing instantly accessible with a **no-login** online experience, adds durable long-term memory for users and teams, brings full token-usage visibility to every chat, introduces AI file sorting, and ships a brand-new knowledge base export feature. It turns Nowing into an even more practical **free alternative to ChatGPT** for real knowledge work.

### No-Login Online Experience

- **ChatGPT Online, No Login Required**: Try Nowing online for free without signing up. First-time visitors can chat and test the **free ChatGPT alternative** experience instantly, with free tokens included.
...
v0.0.16 makes Nowing the easiest open source AI assistant to actually try: zero friction, no login, online. Whether you're searching for a **ChatGPT alternative free online**, a **free Claude AI alternative**, or a **NotebookLM alternative** you can self-host, Nowing v0.0.16 is built for you.
