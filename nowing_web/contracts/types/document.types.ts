...
/**
 * Nowing documentation schemas
 * Follows the same pattern as document/documentWithChunks
 */
export const nowingDocsChunk = z.object({
	id: z.number(),
	content: z.string(),
});

export const nowingDocsDocument = z.object({
	id: z.number(),
	title: z.string(),
	source: z.string(),
	content: z.string(),
...
export const nowingDocsDocumentWithChunks = nowingDocsDocument.extend({
	chunks: z.array(nowingDocsChunk),
});
...
/**
 * Get Nowing docs by chunk
 */
export const getNowingDocsByChunkRequest = z.object({
	chunk_id: z.number(),
});

export const getNowingDocsByChunkResponse = nowingDocsDocumentWithChunks;

/**
 * List Nowing docs
 */
export const getNowingDocsRequest = z.object({
	queryParams: paginationQueryParams.extend({
		title: z.string().optional(),
	}),
});

export const getNowingDocsResponse = z.object({
	items: z.array(nowingDocsDocument),
	total: z.number(),
	page: z.number(),
	page_size: z.number(),
	has_more: z.boolean(),
...
export type NowingDocsChunk = z.infer<typeof nowingDocsChunk>;
export type NowingDocsDocument = z.infer<typeof nowingDocsDocument>;
export type NowingDocsDocumentWithChunks = z.infer<typeof nowingDocsDocumentWithChunks>;
export type GetNowingDocsByChunkRequest = z.infer<typeof getNowingDocsByChunkRequest>;
export type GetNowingDocsByChunkResponse = z.infer<typeof getNowingDocsByChunkResponse>;
export type GetNowingDocsRequest = z.infer<typeof getNowingDocsRequest>;
export type GetNowingDocsResponse = z.infer<typeof getNowingDocsResponse>;
