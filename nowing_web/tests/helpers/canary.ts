 ...
 * (see nowing_backend/tests/e2e/fakes/fixtures/drive_files.json).
...
export const CANARY_TOKENS = {
	driveCanaryFile: "NOWING_E2E_CANARY_TOKEN_DRIVE_001",
	drivePdfCanary: "NOWING_E2E_CANARY_TOKEN_DRIVE_PDF_001",
	composioDrivePdfCanary: "NOWING_E2E_CANARY_TOKEN_COMPOSIO_DRIVE_PDF_001",
	driveReadme: "NOWING_E2E_README_MARKER",
	driveBudget: "NOWING_E2E_BUDGET_MARKER",
	driveRoadmap: "NOWING_E2E_ROADMAP_MARKER",
	driveArchive: "NOWING_E2E_ARCHIVE_MARKER",
	gmailCanary: "NOWING_E2E_CANARY_TOKEN_GMAIL_001",
	calendarCanary: "NOWING_E2E_CANARY_TOKEN_CALENDAR_001",
	onedriveCanary: "NOWING_E2E_CANARY_TOKEN_ONEDRIVE_001",
	onedrivePdfCanary: "NOWING_E2E_CANARY_TOKEN_ONEDRIVE_PDF_001",
	dropboxCanary: "NOWING_E2E_CANARY_TOKEN_DROPBOX_001",
	dropboxPdfCanary: "NOWING_E2E_CANARY_TOKEN_DROPBOX_PDF_001",
	notionCanary: "NOWING_E2E_CANARY_TOKEN_NOTION_001",
	confluenceCanary: "NOWING_E2E_CANARY_TOKEN_CONFLUENCE_001",
	linearCanary: "NOWING_E2E_CANARY_TOKEN_LINEAR_001",
	jiraCanary: "NOWING_E2E_CANARY_TOKEN_JIRA_001",
	slackCanary: "NOWING_E2E_CANARY_TOKEN_SLACK_001",
	clickupCanary: "NOWING_E2E_CANARY_TOKEN_CLICKUP_001",
...
export const FAKE_NOTION_PAGES = {
	canary: {
		...
		workspaceName: "Nowing E2E Notion Workspace",
...
export const FAKE_CONFLUENCE_PAGES = {
	canary: {
		...
		baseUrl: "https://nowing-e2e-confluence.atlassian.net",
	},
} as const;
...
export const FAKE_LINEAR_ISSUES = {
	canary: {
		...
		organizationName: "Nowing E2E Linear Org",
		organizationUrlKey: "nowing-e2e",
	},
} as const;
...
export const FAKE_JIRA_ISSUES = {
	canary: {
		...
		siteUrl: "https://nowing-e2e.atlassian.net",
	},
} as const;
...
export const FAKE_SLACK_CHANNELS = {
	canary: {
		...
		teamName: "Nowing E2E Slack Workspace",
	},
} as const;
...
export const FAKE_CLICKUP_TASKS = {
	canary: {
		...
		workspaceName: "Nowing E2E ClickUp Workspace",
	},
} as const;
