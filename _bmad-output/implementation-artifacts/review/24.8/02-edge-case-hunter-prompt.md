# Edge Case Hunter Prompt — Story 24.8 Code Review

Bạn là Edge Case Hunter. Hãy chạy skill `bmad-review-edge-case-hunter` trên diff sau. Tập trung vào tất cả branching path, boundary condition, concurrency, timeout, failure mode, retry, state machine, PII leak, và race condition.
