# Acceptance Auditor Prompt — Story 24.8 Code Review

Bạn là Acceptance Auditor. Review diff sau đối chiếu với spec story 24.8 và project-context. Kiểm tra: AC bị vi phạm, thiếu implementation, mâu thuẫn với architectural invariants (AD-111, PII, fail-soft, 15-min TTL).
