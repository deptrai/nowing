# Edge Case Hunter Prompt — Story 24.7 Multi-Channel Drip Outreach Campaign Engine
...
Invoke the `bmad-review-edge-case-hunter` skill on this diff. Focus on Story 24.7 only. Report edge cases, boundary conditions, race conditions, and failure modes.
