...
## Phụ lục B: UX Design cho Epic 13 (Institutional Data Terminal)
...
- **Dynamic Grid Workspace:** Khác với Split-pane (Chat trái / Tài liệu phải) của MVP, Epic 13 yêu cầu một layout dạng Grid (giống Bloomberg Terminal hoặc TradingView). Người dùng có thể thêm/bớt/kéo thả các "Widget/Panel" dữ liệu trên màn hình.
...
#### 2.1. Smart Money Sankey Diagram (Story 13.1)
...
#### 2.2. Tokenomics Sandbox (Story 13.2)
...
#### 2.3. Narrative Heatmap (Story 13.3)
