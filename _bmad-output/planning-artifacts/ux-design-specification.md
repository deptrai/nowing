...
```
Click `Resume view` → quay lại session, strip restore full size. Tận dụng kiến trúc Local-first (Sec 1) — partial results đã sync xuống PGLite, không mất khi refresh.

---

### 6. Component Specifications (shadcn/ui implementation)
