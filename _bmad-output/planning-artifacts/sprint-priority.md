...
**`epic-6-retrospective`** was completed 2026-09-10 and is now `done`.

The next action is to continue **`bmad-retrospective`** for the remaining open optional retrospectives, starting with **`epic-7-retrospective`**.
...
- `epic-7-retrospective` — Multi-surface Clients retrospective (next)
