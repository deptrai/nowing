...
|-----------|-----------|------|
| Pricing Page | **Đã tồn tại** — route `/pricing` | `nowing_web/app/(home)/pricing/page.tsx` |
| Pricing Section | **Đã tồn tại** — 3 tiers (FREE / PAY AS YOU GO / ENTERPRISE) | `nowing_web/components/pricing/pricing-section.tsx` |
...
### References
- `nowing_web/components/pricing/pricing-section.tsx` — pricing UI hiện tại
- `nowing_web/app/(home)/pricing/page.tsx` — pricing page route
...
### File List
- `nowing_web/components/pricing/pricing-section.tsx` — rewritten: subscription tiers, Stripe CTA, offline degradation
- `nowing_web/components/pricing.tsx` — updated: PricingPlan interface, toggle enabled, button renders onAction/Link
