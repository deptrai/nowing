...
| 2 | **Browser Operator** (Chrome extension, CDP, logged-in session automation, human takeover) | AD-111; Story `24.8` (Full Browser Operator Chrome Extension); Epic 24 | 📋 Backlog | `24-8` is `backlog`. Need to implement Chrome MV3 extension, CDP bridge, Human Live Takeover UI. |
...
- **📋 Backlog / planned:** 5/26 (Browser Operator, Mail, Sandbox Excel); **✅ Ready-for-dev:** 3/26 (Web Builder, Slides, Design View)
...
1. **Story 24.8 (Browser Operator Chrome Extension)** — enables agent to act inside user's logged-in sessions; `backlog`.
