...
Nowing là nền tảng tìm kiếm và quản lý kiến thức được hỗ trợ bởi AI, giúp bạn:
...
2. **Kích Hoạt Extension:**
   - Click vào icon Nowing trên thanh công cụ trình duyệt
   - Đăng nhập bằng tài khoản của bạn
   - Cấp quyền truy cập cần thiết

3. **Xác Nhận Cài Đặt:**
   - Icon Nowing sẽ xuất hiện trên thanh công cụ
   - Bạn sẽ thấy thông báo "Connected" khi extension hoạt động

### Bước 2: Truy Cập Web Dashboard

1. Mở trình duyệt và truy cập: `https://app.nowing.ai` (hoặc URL do admin cung cấp)
...
3. **Semantic Search (Tìm Kiếm Ngữ Nghĩa):**
   - Nowing sử dụng AI để hiểu ý nghĩa câu hỏi
...
Nowing cho phép bạn kết nối với **26+ ứng dụng bên ngoài** như Gmail, Google Drive, Slack, Notion, Linear, và nhiều hơn nữa. Sau khi kết nối, bạn có thể tìm kiếm thông tin từ **tất cả các ứng dụng này** ngay trong Nowing!
...
3. **Xác Thực (OAuth):**
   ...
   - Đăng nhập và cấp quyền **chỉ đọc** (read-only) cho Nowing
   - Nowing **KHÔNG** có quyền xóa hoặc chỉnh sửa dữ liệu của bạn

4. **Indexing Tự Động:**
   - Sau khi kết nối, Nowing sẽ tự động:
...
- **Kết nối Google Drive:** Tìm files và documents ngay trong Nowing
...
**Triệu chứng:** Icon Nowing không hiển thị hoặc không capture được nội dung.
...
2. **Refresh Extension:**
   - Click icon Nowing → **"Refresh"**
   - Hoặc reload trang web (`F5`)

3. **Kiểm tra quyền truy cập:**
   - Vào `chrome://extensions/` → Nowing → **"Details"**
...
3. **Kiểm tra trạng thái sync:**
   - Click icon Nowing → Xem **"Sync Status"**
...
- **Email:** support@nowing.ai
- **Live Chat:** Click icon **"Help"** ở góc dưới bên phải Dashboard
- **Documentation:** [https://docs.nowing.ai](https://docs.nowing.ai)
- **Community Forum:** [https://community.nowing.ai](https://community.nowing.ai)
...
- [Getting Started with Nowing (5 phút)](https://youtube.com/nowing/getting-started)
- [Advanced Search Techniques (10 phút)](https://youtube.com/nowing/advanced-search)
- [Using AI Chat Effectively (15 phút)](https://youtube.com/nowing/ai-chat)
