...
class _StrictFakeMixin:
    ...
    def __getattr__(self, name: str) -> Any:
        raise NotImplementedError(
            ...
            f"nowing_backend/tests/e2e/fakes/native_google.py."
        )
...
class _FakeGmailUsers(_StrictFakeMixin):
    ...
    def getProfile(self, **kwargs: Any) -> _FakeRequest:  # noqa: N802
        ...
        return _FakeRequest({"emailAddress": "native-drive-e2e@nowing.example"})
...
class _FakeCalendarEvents(_StrictFakeMixin):
    ...
    def list(self, **kwargs: Any) -> _FakeRequest:
        ...
        return _FakeRequest(
            {
                "items": items,
                "summary": "native-calendar-e2e@nowing.example",
                "timeZone": "UTC",
            }
        )
