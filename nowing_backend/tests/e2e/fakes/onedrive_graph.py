...
class _StrictFakeMixin:
    ...
    def __getattr__(self, name: str) -> Any:
        raise NotImplementedError(
            ...
            f"nowing_backend/tests/e2e/fakes/onedrive_graph.py."
        )
    ...
    async def get(self, url: str, *args: Any, **kwargs: Any) -> httpx.Response:
        ...
        if url == "https://graph.microsoft.com/v1.0/me":
            return _json_response(
                ...
                url,
                {
                    "mail": "onedrive-e2e@nowing.example",
                    "userPrincipalName": "onedrive-e2e@nowing.example",
                    "displayName": "Nowing OneDrive E2E",
                },
            )
