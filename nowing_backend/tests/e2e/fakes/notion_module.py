...
class _StrictFakeMixin:
    ...
    def __getattr__(self, name: str) -> Any:
        raise NotImplementedError(
            ...
            "Add it to nowing_backend/tests/e2e/fakes/notion_module.py."
        )
        ...
        return _FakeTokenResponse(
            {
                ...
                "workspace_name": "Nowing E2E Notion Workspace",
                "workspace_icon": "https://nowing.example/notion-icon.png",
