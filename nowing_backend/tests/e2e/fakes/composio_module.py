...
_DRIVE_DOWNLOAD_DIR = Path("/tmp/nowing-e2e-composio-downloads")
...
class _StrictFakeMixin:
    ...
    def __getattr__(self, name: str) -> Any:
        raise NotImplementedError(
            ...
            f"nowing_backend/tests/e2e/fakes/composio_module.py — "
    ...
    def execute(
        ...
        **_: Any,
        ...
        if slug == "GOOGLEDRIVE_GET_ABOUT":
            ...
            return {"data": {"user": {"emailAddress": "e2e-fake@nowing.example"}}}
        if slug == "GMAIL_GET_PROFILE":
            return {"data": {"emailAddress": "e2e-fake@nowing.example"}}
        ...
        if slug == "GOOGLECALENDAR_GET_CALENDAR":
            return {
                "data": {
                    "id": "primary",
                    "summary": "e2e-fake@nowing.example",
                    "primary": True,
                    "timeZone": "UTC",
                }
            }
        ...
        raise NotImplementedError(
            ...
            f"Add it to nowing_backend/tests/e2e/fakes/composio_module.py "
                ...
                "files": [
                    {
                        ...
                        "owners": [
                            {
                                "me": True,
                                "emailAddress": "e2e-fake@nowing.example",
                            }
                        ],
                    }
                ],
...
def _drive_download_file(args: dict[str, Any]) -> dict[str, Any]:
    ...
    if contents is None:
        ...
        raise NotImplementedError(
            ...
            f"nowing_backend/tests/e2e/fakes/fixtures/drive_files.json."
        )
...
def _gmail_fetch_message_by_message_id(args: dict[str, Any]) -> dict[str, Any]:
    ...
    if detail is None:
        raise NotImplementedError(
            ...
            f"nowing_backend/tests/e2e/fakes/fixtures/gmail_messages.json."
        )
    return {"data": detail}
