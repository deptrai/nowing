"""Tests for NowingCompactionMiddleware: protected SystemMessage handling and content sanitization."""
...
class TestPartitionMessages:
    ...
    def _build_partitioner(self):
        ...
        # NowingCompactionMiddleware without a real model, but the
        ...
        class _Stub(NowingCompactionMiddleware):
            def __init__(self):
