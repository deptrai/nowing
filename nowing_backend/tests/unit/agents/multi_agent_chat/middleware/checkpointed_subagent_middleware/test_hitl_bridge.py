...
async def test_resume_bridge_dispatches_decision_into_pending_subagent():
    ...
    parent_config["configurable"]["nowing_resume_value"] = {
    ...
    assert "nowing_resume_value" not in parent_config["configurable"]
...
async def test_full_resume_routing_glue_for_two_paused_subagents():
    ...
    parent_config["configurable"]["nowing_resume_value"] = routed
