...
Credentials are overridable via env vars:
  ADMIN_EMAIL    (default: admin@nowing.ai)
  ADMIN_PASSWORD (default: Admin@Nowing1)
...
def upgrade() -> None:
    ...
    admin_email = os.environ.get("ADMIN_EMAIL", "admin@nowing.ai")
    admin_password = os.environ.get("ADMIN_PASSWORD", "Admin@Nowing1")
    if not os.environ.get("ADMIN_PASSWORD"):
        print(
            "\n⚠️  WARNING: ADMIN_PASSWORD env var not set. "
            "Using default password 'Admin@Nowing1'. "
