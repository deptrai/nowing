...
:class:`~app.agents.chat.multi_agent_chat.shared.state.filesystem_state.NowingFilesystemState`
...
def with_receipt(
    *,
    ...
    field of :class:`~app.agents.chat.multi_agent_chat.shared.state.filesystem_state.NowingFilesystemState`,
