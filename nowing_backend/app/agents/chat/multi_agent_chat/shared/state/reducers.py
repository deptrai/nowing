"""Reducers and sentinels for Nowing filesystem state.
...
_CLEAR: Final[str] = "\x00__NOWING_FILESYSTEM_CLEAR__\x00"
...
def _initial_filesystem_state() -> dict[str, Any]:
    """Default empty values for Nowing filesystem state fields.
