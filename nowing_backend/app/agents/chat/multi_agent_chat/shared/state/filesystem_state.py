"""LangGraph state schema additions used by the Nowing filesystem agent.
...
class NowingFilesystemState(FilesystemState):
    """Filesystem state used by the Nowing agent (cloud + desktop).
