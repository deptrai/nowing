"""``knowledge_base`` route: full and read-only ``NowingSubagentSpec`` builders.
...
def build_subagent(
    *,
    ...
    return NowingSubagentSpec(spec=spec, ruleset=KB_RULESET)
...
def build_readonly_subagent(
    *,
    ...
    return NowingSubagentSpec(spec=spec, ruleset=_KB_READONLY_RULESET)
