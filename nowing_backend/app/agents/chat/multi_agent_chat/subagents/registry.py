...
from app.agents.chat.multi_agent_chat.subagents.builtins.batdongsan.agent import (
    build_subagent as build_batdongsan_subagent,
)
from app.agents.chat.multi_agent_chat.subagents.builtins.cafef.agent import (
    build_subagent as build_cafef_subagent,
)
...
from app.agents.chat.multi_agent_chat.subagents.builtins.vietstock.agent import (
    build_subagent as build_vietstock_subagent,
)
from app.agents.chat.multi_agent_chat.subagents.builtins.vn_jobs.agent import (
    build_subagent as build_vn_jobs_subagent,
)
...
SUBAGENT_BUILDERS_BY_NAME: dict[str, SubagentBuilder] = {
    ...
    "vietstock": build_vietstock_subagent,
    "vn_jobs": build_vn_jobs_subagent,
