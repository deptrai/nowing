...
one format. Nowing-specific extras (FE card discriminator, structured
...
# ``approve_always`` is a Nowing extension surfaced by ``PermissionMiddleware``
...
NOWING_DECISION_APPROVE_ALWAYS = "approve_always"
    ...
    *,
    ...
    Args:
        ...
        allowed_decisions: Subset of
            ...
            NOWING_DECISION_APPROVE_ALWAYS]``. Other values are passed through
            but the FE may not render a control for them.
        interrupt_type: Nowing card discriminator (``"gmail_email_send"``,
    ...
    Returns:
        ...
        Nowing extensions (``interrupt_type``, ``context``) sit alongside
...
__all__ = [
    ...
    "LC_DECISION_EDIT",
    "LC_DECISION_REJECT",
    "NOWING_DECISION_APPROVE_ALWAYS",
