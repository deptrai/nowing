    ...
    *,
    ...
    try:
        async with shielded_async_session() as session:
            ...
            action_id_by_call = await _resolve_action_ids(
                session,
                thread_id=thread_id,
                snapshot_enabled=snapshot_enabled,
                staged_dir_tool_calls=staged_dir_tool_calls,
                pending_moves=pending_moves,
                dirty_path_tool_calls=dirty_path_tool_calls,
                file_delete_paths=file_delete_paths,
                dir_delete_paths=dir_delete_paths,
            )
...
__all__ = ["commit_staged_filesystem_state"]
