...
from ...tools import MAIN_AGENT_NOWING_TOOL_NAMES_ORDERED
...
def build_tools_instruction_block(
    *,
    ...
    for tool_name in MAIN_AGENT_NOWING_TOOL_NAMES_ORDERED:
    ...
    known_disabled = (
        set(disabled_tool_names) & set(MAIN_AGENT_NOWING_TOOL_NAMES_ORDERED)
    ...
    if known_disabled:
        disabled_list = ", ".join(
            ...
            for n in MAIN_AGENT_NOWING_TOOL_NAMES_ORDERED
