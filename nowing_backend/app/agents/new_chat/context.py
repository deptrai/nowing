"""
Context schema definitions for Nowing agents.

This module defines the custom state schema used by the Nowing deep agent.
"""

from typing import TypedDict


class NowingContextSchema(TypedDict):
    """
    Custom state schema for the Nowing deep agent.
