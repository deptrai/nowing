"""Custom filesystem middleware for the Nowing agent.

This middleware customizes prompts and persists write/edit operations for
`/documents/*` files into Nowing's `Document`/`Chunk` tables.
"""
...
NOWING_FILESYSTEM_SYSTEM_PROMPT = """## Following Conventions
...
NOWING_LIST_FILES_TOOL_DESCRIPTION = """Lists files and directories at the given path.
"""

NOWING_READ_FILE_TOOL_DESCRIPTION = """Reads a file from the filesystem.
...
NOWING_WRITE_FILE_TOOL_DESCRIPTION = """Writes a new file to the in-memory filesystem (session-only).
...
NOWING_EDIT_FILE_TOOL_DESCRIPTION = """Performs exact string replacements in files.
...
NOWING_GLOB_TOOL_DESCRIPTION = """Find files matching a glob pattern.

Supports standard glob patterns: `*`, `**`, `?`.
Returns absolute file paths.
"""

NOWING_GREP_TOOL_DESCRIPTION = """Search for a literal text pattern across files.

Use this to locate relevant document files/chunks before reading full files.
"""

NOWING_SAVE_DOCUMENT_TOOL_DESCRIPTION = """Permanently saves a document to the user's knowledge base.
...
class NowingFilesystemMiddleware(FilesystemMiddleware):
    """Nowing-specific filesystem middleware with DB persistence for docs."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            system_prompt=NOWING_FILESYSTEM_SYSTEM_PROMPT,
            custom_tool_descriptions={
                "ls": NOWING_LIST_FILES_TOOL_DESCRIPTION,
                "read_file": NOWING_READ_FILE_TOOL_DESCRIPTION,
                "write_file": NOWING_WRITE_FILE_TOOL_DESCRIPTION,
                "edit_file": NOWING_EDIT_FILE_TOOL_DESCRIPTION,
                "glob": NOWING_GLOB_TOOL_DESCRIPTION,
                "grep": NOWING_GREP_TOOL_DESCRIPTION,
            },
    ...
    def _create_save_document_tool(self) -> BaseTool:
        ...
        return StructuredTool.from_function(
            name="save_document",
            description=NOWING_SAVE_DOCUMENT_TOOL_DESCRIPTION,
    ...
    def _create_write_file_tool(self) -> BaseTool:
        ...
        tool_description = (
            ...
            or NOWING_WRITE_FILE_TOOL_DESCRIPTION
        )
    ...
    def _create_edit_file_tool(self) -> BaseTool:
        ...
        tool_description = (
            ...
            or NOWING_EDIT_FILE_TOOL_DESCRIPTION
        )
