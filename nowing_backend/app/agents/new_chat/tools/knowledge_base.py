"""
Knowledge base search tool for the Nowing agent.
...
CONNECTOR_DESCRIPTIONS: dict[str, str] = {
    "EXTENSION": "Web content saved via Nowing browser extension (personal browsing history)",
    "FILE": "User-uploaded documents (PDFs, Word, etc.) (personal files)",
    "NOTE": "Nowing Notes (notes created inside Nowing)",
    ...
    "WEBCRAWLER_CONNECTOR": "Webpages indexed by Nowing (personally selected websites)",
    "CRAWLED_URL": "Webpages indexed by Nowing (personally selected websites)",
