"""Canonical Zero publication definition for Nowing.
...
Nowing runs Zero on Postgres with Zero's event triggers installed, so the
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Manage Nowing's Zero publication")
    parser.add_argument(
