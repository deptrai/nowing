...
class TeamsHistory:
    ...
    async def get_all_teams(self) -> list[dict[str, Any]]:
        ...
        try:
            ...
            return teams
        except Exception as e:  # upstream API failure; log error and raise
    ...
    async def get_messages_from_channel(
        ...
        try:
            ...
            if include_replies:
                ...
                for message in messages:
                    ...
                    except Exception:  # message replies fetch failure; continue without replies
                        logger.warning(
        ...
        except Exception as e:  # channel messages fetch failure; log error and raise
            logger.error(
    ...
    async def get_all_messages_from_team(
        ...
        try:
            ...
            for channel in channels:
                ...
                except Exception:  # per-channel message fetch failure; set empty list and continue batch
                    logger.error(
        ...
        except Exception as e:  # team messages fetch failure; log error and raise
    ...
    async def get_all_messages(
        ...
        try:
            ...
            for team in teams:
                ...
                except Exception:  # per-team message fetch failure; set empty dict and continue batch
                    logger.error(
        ...
        except Exception as e:  # all messages fetch failure; log error and raise
