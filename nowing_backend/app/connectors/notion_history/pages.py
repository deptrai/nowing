...
class NotionPagesMixin:
    ...
    async def _get_first_accessible_parent(self) -> str | None:
        ...
        except Exception as e:  # parent page search failure; return None
    ...
    async def create_page(
        ...
        except Exception as e:  # page creation unexpected failure; return status error
    ...
    async def update_page(
        ...
        try:
            ...
            if content:
                ...
                except Exception as e:  # markdown to blocks conversion failure; return status error
                ...
                except Exception as e:  # content block append failure; return status error
        ...
        except Exception as e:  # page update unexpected failure; return status error
    ...
    async def delete_page(self, page_id: str) -> dict[str, Any]:
        ...
        except Exception as e:  # page deletion unexpected failure; return status error
