...
class GoogleDriveClient:
    ...
    async def get_service(self):
        ...
        async with self._service_lock:
            ...
            try:
                ...
                return self.service
            except Exception as e:  # service initialization failure; raise Exception
    ...
    def _sync_download_file(
        ...
        except Exception as e:  # upstream API download failure; return None and error
    ...
    def _sync_download_file_to_disk(
        ...
        except Exception as e:  # upstream API download-to-disk failure; return error
    ...
    def _sync_export_google_file(
        ...
        except Exception as e:  # upstream API export failure; return None and error
