...
async def download_and_process_file(
    ...
    """
    Download Google Drive file and process using Nowing file processors.
    ...
    try:
        ...
        logger.info(f"Processing {file_name} with Nowing's file processor")
    ...
    except Exception as e:  # best-effort cleanup; temp file removal failure is non-fatal
