"""
Elasticsearch connector for Nowing
"""
...
class ElasticsearchConnector:
    ...
    def __init__(
        ...
        except Exception as e:  # client initialization failure; log and raise
    ...
    async def search(
        ...
        try:
            ...
            raise
        except Exception as e:  # search query failure; log and raise
    ...
    async def get_indices(self) -> list[str]:
        ...
        except Exception as e:  # index retrieval failure; log and raise
    ...
    async def get_mapping(self, index: str) -> dict[str, Any]:
        ...
        except Exception as e:  # index mapping retrieval failure; log and raise
    ...
    async def scroll_search(
        ...
        try:
            ...
            if scroll_id:
                ...
                except Exception:  # best-effort cleanup; clear_scroll failure is non-fatal
                    logger.debug("Failed to clear scroll id (non-fatal)")

        except Exception as e:  # scroll search failure; log and raise
    ...
    async def count_documents(
        ...
        except Exception as e:  # count query failure; log and raise
