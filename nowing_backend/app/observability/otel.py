"""
OpenTelemetry instrumentation helpers for the Nowing agent stack.
...
_INSTRUMENTATION_NAME = "nowing.new_chat"
...
def _resolve_enabled() -> bool:
    ...
    if os.environ.get("NOWING_DISABLE_OTEL", "").lower() in {"1", "true", "yes"}:
        return False
...
def reload_for_tests() -> bool:
    ...
    ``NOWING_DISABLE_OTEL`` can call this to reset cached state.
