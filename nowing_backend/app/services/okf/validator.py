"""Minimal OKF v0.2 conformance checks.
...
# The OKF v0.2 frontmatter contract, shared by serializer and validator. Only
...
def is_conformant_concept(text: str) -> bool:
    """True if a single concept document conforms to OKF v0.2."""
