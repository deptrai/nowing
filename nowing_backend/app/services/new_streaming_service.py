...
class VercelStreamingService:
    ...
    def format_further_questions(self, questions: list[str]) -> str:
        """
        Format further questions as custom data (Nowing specific).
    ...
    def format_thinking_step(
        ...
        """
        Format a thinking step for chain-of-thought display (Nowing specific).
    ...
    def format_thread_title_update(self, thread_id: int, title: str) -> str:
        """
        Format a thread title update notification (Nowing specific).
