...
WEB_BUILDER_TXT_VERIFY_LABEL = os.getenv(
    "WEB_BUILDER_TXT_VERIFY_LABEL", "_nowing-verify"
)
WEB_BUILDER_TXT_VERIFY_PREFIX = os.getenv(
    "WEB_BUILDER_TXT_VERIFY_PREFIX", "nowing-verify="
)
