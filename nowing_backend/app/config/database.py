...
# Story 37.2 / AD-116: sender demographics for honorific age differential.
SEQUENCER_SENDER_BIRTH_YEAR: int = _env_int("SEQUENCER_SENDER_BIRTH_YEAR", 0)
SEQUENCER_SENDER_GENDER: str = os.getenv("SEQUENCER_SENDER_GENDER", "").strip().lower()
...
__all__ = ['AD_41_REACTIVATED', 'DATABASE_URL', 'DB_BOOTSTRAP_ON_STARTUP', 'DB_CELERY_IDLE_IN_TX_TIMEOUT_MS', 'DB_DDL_LOCK_TIMEOUT_MS', 'DB_IDLE_IN_TX_TIMEOUT_MS', 'SEQUENCER_OUTBOUND_CHANNELS', 'SEQUENCER_SENDER_BIRTH_YEAR', 'SEQUENCER_SENDER_GENDER', 'SEQUENCE_EMAIL_COST_MICROS', 'SEQUENCE_TELEGRAM_COST_MICROS', 'SEQUENCE_ZNS_COST_MICROS', 'SEQUENCE_ZNS_MAX_RESCHEDULE_HOURS']
