...
__all__ = ['DSH_CONSUMER_GROUP', 'DSH_EXECUTOR_ENGINE', 'DSH_HEARTBEAT_INTERVAL_SECONDS', 'DSH_INTERNAL_BASE_URL', 'DSH_LOCK_TTL_SECONDS', 'DSH_MAX_PAYLOAD_BYTES', 'DSH_MAX_RETRIES', 'DSH_REDIS_BLOCK_MS', 'DSH_STREAM_DLQ', 'DSH_STREAM_TASKS', 'DSH_SYNC_TIMEOUT_SECONDS', 'DSH_TELEGRAM_CALLBACK_RATE_LIMIT_PER_MINUTE', 'DSH_TELEGRAM_FIT_SCORE_THRESHOLD', 'DSH_TELEGRAM_MAX_LEADS_PER_MISSION', 'DSH_TELEGRAM_REFUND_CAP_PCT', 'DSH_TELEGRAM_REFUND_WINDOW_HOURS', 'DSH_WORKER_PAT', 'DSH_WORKER_SECRET', 'DSH_XAUTOCLAIM_MIN_IDLE_MS', '_raw_refund_cap_pct']
