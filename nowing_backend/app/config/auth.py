...
# Secondary key for zero-downtime SECRET_KEY rotation (Story 33.1).
# When set, decryption falls back to this key for legacy records.
...
__all__ = ['ACCESS_TOKEN_LIFETIME_SECONDS', 'AUTH_TYPE', 'CAPTCHA_MAX_ATTEMPTS_PER_URL', 'CAPTCHA_SOLVER_API_KEY', 'CAPTCHA_SOLVER_PROVIDER', 'CAPTCHA_SOLVE_TIMEOUT_S', 'CAPTCHA_SOLVING_ENABLED', 'CAPTCHA_TYPE_DEFAULT', 'CAPTCHA_V3_ACTION', 'CAPTCHA_V3_MIN_SCORE', 'COOKIE_DOMAIN', 'CSRF_ALLOWED_ORIGINS', 'CSRF_ALLOW_LOOPBACK', 'MIN_ISSUED_AT', 'PAT_MAX_EXPIRY_DAYS', 'REFRESH_ABSOLUTE_LIFETIME_SECONDS', 'REFRESH_COOKIE_NAME', 'REFRESH_ROTATION_GRACE_SECONDS', 'REFRESH_TOKEN_LIFETIME_SECONDS', 'REGISTRATION_ENABLED', 'SECRET_KEY', 'SECONDARY_SECRET_KEY', 'SESSION_COOKIE_NAME', 'SESSION_COOKIE_SAMESITE', 'SESSION_COOKIE_SECURE_POLICY', 'TURNSTILE_ENABLED', 'TURNSTILE_SECRET_KEY', '_CSRF_ALLOW_LOOPBACK', '_PAT_MAX_EXPIRY_DAYS']
