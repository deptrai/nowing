...
HELP_TEXT = (
    "Nowing Slack commands:\n"
    "`/new` - start a fresh Nowing conversation in this thread\n"
    "`/help` - show this help\n\n"
    "Mention the Nowing bot in a channel thread to ask your agent a question."
)
    ...
    async def send_unbound_onboarding(
        ...
        *,
        ...
        await adapter.send_message(
            ...
            reply_to_message_id=thread_ts,
            text=(
                "Hi! Connect your Slack user to Nowing before using the bot here: "
                f"{dashboard_url}"
            ),
        )
