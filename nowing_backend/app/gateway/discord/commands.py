...
HELP_TEXT = (
    "Nowing Discord commands:\n"
    "`/new` - start a fresh Nowing conversation for this Discord thread\n"
    "`/help` - show this help\n\n"
    "Mention the Nowing bot in a Discord channel to ask your agent a question. "
    "Discord search remains controlled by the Discord connector in Nowing."
)
    ...
    async def send_unbound_onboarding(
        ...
        *,
        ...
        await adapter.send_message(
            ...
            reply_to_message_id=message_id,
            text=(
                "Hi! Connect your Discord user to Nowing before using the bot here: "
                f"{dashboard_url}"
            ),
        )
