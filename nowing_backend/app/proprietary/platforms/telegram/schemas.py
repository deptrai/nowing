...
class ExtractedEntities(BaseModel):
    ...
    phone_numbers: list[str] = Field(default_factory=list, description="Extracted Vietnamese phone numbers")
    emails: list[str] = Field(default_factory=list, description="Extracted email addresses")
    prices: list[str] = Field(default_factory=list, description="Extracted prices and currency values")
    hashtags: list[str] = Field(default_factory=list, description="Extracted hashtags")
    intent_tag: str = Field(default="news", description="Intent classification: 'sell', 'buy', 'seeking', 'news'")
...
class TelegramChannelInfo(BaseModel):
    ...
    is_megagroup: bool = Field(default=False, description="Whether channel is a megagroup/forum")
...
class TelegramMessageParsed(BaseModel):
    ...
    has_media: bool = Field(default=False, description="Whether message contains photo/video/doc")
    media_urls: list[str] = Field(default_factory=list, description="Preview media URLs")
