...
def _extract_prices(text: str) -> list[dict[str, Any]]:
    ...
    # 1. Compound prices: e.g. "18 tỷ 500tr" or "18 tỷ 500"
    for match in _PRICE_COMPOUND_REGEX.finditer(text):
        ...
        trieu_val = float(match.group(3).replace(",", "."))

        # If trieu_val is like 500, it means 500 million
        if trieu_val < 1000:
    ...
    # 2. Simple prices: e.g. "25.5 tỷ", "8.5 triệu/tháng", "500k/tháng"
