...
This guide walks you through setting up an Atlassian OAuth 2.0 (3LO) integration for Nowing to connect your Jira projects.
...
## Running Nowing with Jira Connector
