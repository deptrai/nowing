...
This guide walks you through setting up a Google OAuth 2.0 integration for Nowing to connect your Google Calendar.
...
## Running Nowing with Google Calendar Connector
