...
This guide walks you through setting up a Microsoft Teams OAuth integration for Nowing using Azure App Registration.
...
## Running Nowing with Microsoft Teams Connector
