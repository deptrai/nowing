...
This guide walks you through connecting your GitHub repositories to Nowing for code search and AI-powered insights.
...
1. Go to [GitHub's token creation page](https://github.com/settings/tokens/new?description=nowing&scopes=repo) (pre-filled with `repo` scope)
2. Set an expiration
