...
This guide walks you through setting up a Discord OAuth integration for Nowing.
...
3. Enter the application name: `Nowing`
4. Click **"Create"**
...
<Callout type="warn">
   Keep **Public Client** disabled (off) since Nowing uses a server to make requests.
</Callout>
...
## Running Nowing with Discord Connector

Add the Discord credentials to your environment configuration:
