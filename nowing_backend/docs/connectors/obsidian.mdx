...
This guide walks you through connecting your Obsidian vault to Nowing for note search and AI-powered insights.

<Callout type="warn">
    This connector requires direct file system access and only works with self-hosted Nowing installations.
</Callout>
...
Add your vault as a volume mount to the Nowing backend service:
...
- Check file permissions: Nowing needs read access to the vault directory
