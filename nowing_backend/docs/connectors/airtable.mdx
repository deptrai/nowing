...
This guide walks you through setting up an Airtable OAuth integration for Nowing.
...
The preview shows what users will see when authorizing Nowing:
...
## Running Nowing with Airtable Connector

Add the Airtable credentials to your environment configuration:
