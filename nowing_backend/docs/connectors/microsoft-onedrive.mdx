...
This guide walks you through setting up a Microsoft OneDrive OAuth integration for Nowing using Azure App Registration.
...
4. Enter a description (e.g., `Nowing`) and select an expiration period
5. Click **"Add"**
...
## Running Nowing with Microsoft OneDrive Connector

Add the Microsoft OAuth credentials to your environment configuration:
