...
DexScreener is a powerful cryptocurrency trading analytics platform that provides real-time data for trading pairs across multiple decentralized exchanges (DEXs). Integrate DexScreener with Nowing to search and analyze crypto market data using AI.

## How it works

The DexScreener connector fetches trading pair data for tokens you specify and indexes it into your Nowing search space. This allows you to:
...
1. Navigate to your Nowing dashboard
