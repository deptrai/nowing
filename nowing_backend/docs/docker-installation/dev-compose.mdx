...
If you're contributing to Nowing and want to build from source, use `docker-compose.dev.yml` instead:
...
| `PGADMIN_DEFAULT_EMAIL` | pgAdmin login email | `admin@nowing.com` |
| `PGADMIN_DEFAULT_PASSWORD` | pgAdmin login password | `nowing` |
