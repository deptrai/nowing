...
``nowing_backend/`` and prints a short PASS/FAIL/SKIP summary at the
...
# Bootstrap the nowing_backend package on sys.path so the script runs
# from the repo root or from `nowing_backend/` interchangeably.
