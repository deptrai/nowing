"""Create the Daytona snapshot used by Nowing code-execution sandboxes.
...
Prerequisites:
    - DAYTONA_API_KEY set in nowing_backend/.env (or exported in shell)
    - DAYTONA_API_URL=https://app.daytona.io/api
    - DAYTONA_TARGET=us  (or eu)

After this script succeeds, add to nowing_backend/.env:
    DAYTONA_SNAPSHOT_ID=nowing-sandbox
"""
...
def main() -> None:
    ...
    if not api_key:
        ...
        print(
            "Add it to nowing_backend/.env or export it in your shell.",
            file=sys.stderr,
        )
        sys.exit(1)
    ...
    print("\nAdd this to nowing_backend/.env:")
