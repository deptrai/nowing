...
const LINUX_DESKTOP_FILENAME = 'nowing.desktop';
...
// ---------------------------------------------------------------------------
// Linux: ~/.config/autostart/nowing.desktop
// ---------------------------------------------------------------------------
...
// First-launch opt-in: register Nowing as a hidden login item so the tray,
