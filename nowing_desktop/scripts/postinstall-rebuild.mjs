...
if (process.platform !== 'darwin') {
  console.log('[nowing-desktop] Skipping electron-rebuild on non-macOS (native permissions module is darwin-only).');
  process.exit(0);
}
...
if (!existsSync(bin)) {
  console.warn('[nowing-desktop] electron-rebuild not found in node_modules/.bin, skipping.');
  process.exit(0);
}
