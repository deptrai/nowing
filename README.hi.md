...
**Nowing विशेष रूप से इन समस्याओं को हल करने के लिए बनाया गया है।** Nowing आपको सक्षम बनाता है:
...
## Nowing का उपयोग कैसे करें

### Cloud

1. [nowing.com](https://www.nowing.com) पर जाएं और लॉगिन करें।

<p align="center"><img src="nowing_web/public/homepage/hero_tutorial/LoginFlowGif.gif" alt="लॉगिन" /></p>

2. अपने कनेक्टर जोड़ें और सिंक करें। कनेक्टर्स को अपडेट रखने के लिए आवधिक सिंकिंग सक्षम करें।

<p align="center"><img src="nowing_web/public/homepage/hero_tutorial/ConnectorFlowGif.gif" alt="कनेक्टर्स" /></p>

3. जब तक कनेक्टर्स का डेटा इंडेक्स हो रहा है, दस्तावेज़ अपलोड करें।

<p align="center"><img src="nowing_web/public/homepage/hero_tutorial/DocUploadGif.gif" alt="दस्तावेज़ अपलोड करें" /></p>
...
4. सब कुछ इंडेक्स हो जाने के बाद, कुछ भी पूछें (उपयोग के मामले):
   ...
   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/video_gen_gif.gif" alt="वीडियो जनरेशन" /></p>

   - बेसिक सर्च और उद्धरण

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/BSNCGif.gif" alt="सर्च और उद्धरण" /></p>

   - दस्तावेज़ मेंशन QNA

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/BQnaGif_compressed.gif" alt="दस्तावेज़ मेंशन QNA" /></p>
   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/BQnaGif_compressed.gif" alt="दस्तावेज़ मेंशन QNA" /></p>

   - रिपोर्ट जनरेशन और एक्सपोर्ट (PDF, DOCX, HTML, LaTeX, EPUB, ODT, सादा टेक्स्ट)

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/ReportGenGif_compressed.gif" alt="रिपोर्ट जनरेशन" /></p>

   - पॉडकास्ट जनरेशन

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/PodcastGenGif.gif" alt="पॉडकास्ट जनरेशन" /></p>

   - इमेज जनरेशन

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/ImageGenGif.gif" alt="इमेज जनरेशन" /></p>
...
पूर्ण डेटा नियंत्रण और गोपनीयता के लिए Nowing को अपने स्वयं के बुनियादी ढांचे पर चलाएं।
...
Docker Compose, मैनुअल इंस्टॉलेशन और अन्य डिप्लॉयमेंट विकल्पों के लिए, [डॉक्स](https://www.nowing.com/docs/) देखें।

### डेस्कटॉप ऐप

Nowing एक डेस्कटॉप ऐप भी प्रदान करता है जो आपके कंप्यूटर पर हर एप्लिकेशन में AI सहायता लाता है। इसे [नवीनतम रिलीज़](https://github.com/MODSetter/Nowing/releases/latest) से डाउनलोड करें।

डेस्कटॉप ऐप में ये शक्तिशाली सुविधाएं शामिल हैं:

- **General Assist** — एक ग्लोबल शॉर्टकट से किसी भी एप्लिकेशन से तुरंत Nowing लॉन्च करें।
...
- **Watch Local Folder** — एक लोकल फ़ोल्डर को वॉच करें और फ़ाइल परिवर्तनों को स्वचालित रूप से अपनी नॉलेज बेस में सिंक करें। **Pro tip:** इसे अपने Obsidian vault पर पॉइंट करें ताकि आपके नोट्स Nowing में सर्च करने योग्य रहें।
...
4. आपकी टीम अब रीयल-टाइम में चैट कर सकती है।
   ...
   <p align="center"><img src="nowing_web/public/homepage/hero_realtime/RealTimeChatGif.gif" alt="रीयल-टाइम चैट" /></p>

5. टीममेट्स को टैग करने के लिए कमेंट जोड़ें।

   <p align="center"><img src="nowing_web/public/homepage/hero_realtime/RealTimeCommentsFlow.gif" alt="रीयल-टाइम कमेंट्स" /></p>

## Nowing vs Google NotebookLM

| विशेषता | Google NotebookLM | Nowing |
|---------|-------------------|-----------|
...
**Nowing सक्रिय रूप से विकसित किया जा रहा है।** हालांकि यह अभी प्रोडक्शन-रेडी नहीं है, आप प्रक्रिया को तेज़ करने में हमारी मदद कर सकते हैं।

[Nowing Discord](https://discord.gg/ejRNvftDp9) में शामिल हों और Nowing के भविष्य को आकार देने में मदद करें!
...
**रोडमैप चर्चा:** [Nowing 2026 Roadmap](https://github.com/MODSetter/Nowing/discussions/565)

**कानबन बोर्ड:** [Nowing Project Board](https://github.com/users/MODSetter/projects/3)
