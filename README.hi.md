<a href="https://www.nowing.com/"><img width="1584" height="396" alt="Nowing — होस्टेड डीप-रिसर्च इंजन वाला open-core AI रिसर्च वर्कस्पेस" src="https://github.com/user-attachments/assets/9361ef58-1753-4b6e-b275-5020d8847261" /></a>
...
>
> **आप जिस भी चीज़ पर निर्भर हैं, वह कहीं नहीं जा रही।** आपका नॉलेज बेस, citations वाली चैट, रिपोर्ट, पॉडकास्ट, प्रेज़ेंटेशन, automation और सहयोगी चैट, सब पहले की तरह काम करते रहेंगे, और Apache-2.0 core का self-hosting मुफ़्त रहेगा। hosted deep-research engine एक optional cloud API key का उपयोग करता है। पूरी घोषणा [हमारे changelog](https://www.nowing.com/changelog) पर पढ़ें।
...
- **open-core और सेल्फ-होस्ट करने योग्य**, ताकि आपकी रिसर्च आपके अपने इन्फ्रास्ट्रक्चर पर ही रहे।
...
Nowing एकमात्र open-core प्रोडक्ट है जो AI एजेंट्स और टीमों के लिए लॉन्ग-टर्म रिसर्च मेमोरी को लाइव-डेटा प्रिमिटिव के साथ जोड़ता है। हर श्रेणी के टूल के मुकाबले यह तुलना कुछ ऐसी दिखती है।
...
**बनाम स्क्रैपर मार्केटप्लेस (Apify)।** मार्केटप्लेस आपको हज़ारों कम्युनिटी ऐक्टर देते हैं, हर एक की अपनी स्कीमा, गुणवत्ता और कीमत। Nowing एक ही टाइप्ड API और एक ही MCP सर्वर है, जिसके पीछे एजेंट हार्नेस और रिसर्च वर्कस्पेस मौजूद है, और यह open-core है।
...
**लाइसेंस एक नज़र में:**
- Core (`nowing_backend/app/proprietary/` के बाहर सब कुछ): **Apache-2.0** — इस्तेमाल और बदलाव क लिए फ्री।
