...
def register(mcp: FastMCP, client: NowingClient, context: WorkspaceContext) -> None:
    ...
    @mcp.tool(
        name="nowing_google_maps_scrape",
    ...
    async def google_maps_scrape(
        ...
        reviews use nowing_google_maps_reviews instead.
    ...
    @mcp.tool(
        name="nowing_google_maps_reviews",
    ...
    async def google_maps_reviews(
        ...
        place_ids: Annotated[
            list[str] | None,
            Field(description="Google place ids from nowing_google_maps_scrape."),
        ] = None,
        ...
        from nowing_google_maps_scrape first if you only have a name.
