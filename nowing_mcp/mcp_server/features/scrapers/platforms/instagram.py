...
def register(mcp: FastMCP, client: NowingClient, context: WorkspaceContext) -> None:
    ...
    async def instagram_scrape(
        ...
        profile's metadata use nowing_instagram_details. Returns per-item
    ...
    async def instagram_details(
        ...
        For a feed of posts use nowing_instagram_scrape instead. Each item
