...
def register(mcp: FastMCP, client: NowingClient, context: WorkspaceContext) -> None:
    ...
    async def youtube_scrape(
        ...
        nowing_youtube_comments instead. Returns per-video metadata (title,
    ...
    async def youtube_comments(
        ...
        nowing_youtube_scrape if you only have a topic. Returns comment
