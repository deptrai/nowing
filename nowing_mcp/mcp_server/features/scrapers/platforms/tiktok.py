...
def register(mcp: FastMCP, client: NowingClient, context: WorkspaceContext) -> None:
    ...
    async def tiktok_scrape(
        ...
        nowing_tiktok_user_search. Example: hashtags=['food'], max_items=20.
        """
    ...
    @mcp.tool(
        name="nowing_tiktok_user_search",
