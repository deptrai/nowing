...
def register(mcp: FastMCP, client: NowingClient, context: WorkspaceContext) -> None:
    ...
    @mcp.tool(
        name="nowing_search_knowledge_base",
    ...
    async def search_knowledge_base(
        ...
        stored in Nowing — notes, uploaded files, saved pages, past
    ...
    async def list_documents(
        ...
        about a topic, prefer nowing_search_knowledge_base. Returns each
