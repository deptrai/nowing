...
def register(mcp: FastMCP, client: NowingClient, context: WorkspaceContext) -> None:
    ...
    async def add_document(
        ...
        on disk use nowing_upload_file instead. Indexing is asynchronous,
    ...
    async def upload_file(
        ...
        for text you already have in hand use nowing_add_document instead.
    ...
    async def update_document(
        ...
        nowing_get_document and resend the combined text. Search chunks are
