...
def register(mcp: FastMCP, context: WorkspaceContext) -> None:
    ...
    async def list_workspaces(
        ...
        """List the Nowing workspaces (search spaces) the account can access.
    ...
    async def select_workspace(
        ...
        Research space"), or after nowing_list_workspaces when several
