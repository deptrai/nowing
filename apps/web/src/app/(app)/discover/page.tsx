...
import type { Discover } from '@/components/Discover/discover.types';
...
const Page = () => {
  ...
  const topics = [
    {
      display: lang === 'vi' ? 'Công nghệ & Khoa học' : 'Tech & Science',
      key: 'tech',
    },
    {
      display: lang === 'vi' ? 'Tài chính & Kinh tế' : 'Finance',
      key: 'finance',
    },
    {
      display: lang === 'vi' ? 'Nghệ thuật & Văn hóa' : 'Art & Culture',
      key: 'art',
    },
    {
      display: lang === 'vi' ? 'Thể thao' : 'Sports',
      key: 'sports',
    },
    {
      display: lang === 'vi' ? 'Giải trí' : 'Entertainment',
      key: 'entertainment',
    },
  ];
        ...
        <div className="flex flex-col pt-10 border-b border-light-200/20 dark:border-dark-200/20 pb-6 px-2">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-center justify-center">
              <Globe2Icon size={45} className="mb-2.5 text-black dark:text-white" />
              <h1
                className="text-5xl font-normal p-2 text-black dark:text-white"
              ...
              {topics.map((t, i) => (
                <div
                  ...
                  className={cn(
                    ...
                    activeTopic === t.key
                      ? 'text-cyan-700 dark:text-cyan-300 bg-cyan-300/20 border-cyan-700/60 dar:bg-cyan-300/30 dark:border-cyan-300/40 font-medium'
