...
**Nowing 正是为了解决这些问题而生。** Nowing 赋予你：
...
1. 访问 [nowing.com](https://www.nowing.com) 并登录。

<p align="center"><img src="nowing_web/public/homepage/hero_tutorial/LoginFlowGif.gif" alt="登录" /></p>

2. 连接您的连接器并同步。启用定期同步以保持连接器数据更新。

<p align="center"><img src="nowing_web/public/homepage/hero_tutorial/ConnectorFlowGif.gif" alt="连接器" /></p>

3. 在连接器数据索引期间，上传文档。

<p align="center"><img src="nowing_web/public/homepage/hero_tutorial/DocUploadGif.gif" alt="上传文档" /></p>
...
4. 一切索引完成后，尽管提问（使用场景）：
   ...
   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/video_gen_gif.gif" alt="视频生成" /></p>

   - 基本搜索和引用

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/BSNCGif.gif" alt="搜索和引用" /></p>

   - 文档提及问答

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/BQnaGif_compressed.gif" alt="文档提及问答" /></p>
   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/BQnaGif_compressed.gif" alt="文档提及问答" /></p>

   - 报告生成和导出（PDF、DOCX、HTML、LaTeX、EPUB、ODT、纯文本）

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/ReportGenGif_compressed.gif" alt="报告生成" /></p>

   - 播客生成

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/PodcastGenGif.gif" alt="播客生成" /></p>

   - 图像生成

   <p align="center"><img src="nowing_web/public/homepage/hero_tutorial/ImageGenGif.gif" alt="图像生成" /></p>
...
在您自己的基础设施上运行 Nowing，实现完全的数据控制和隐私保护。
...
如需 Docker Compose、手动安装及其他部署方式，请查看[文档](https://www.nowing.com/docs/)。

### 桌面应用

Nowing 还提供桌面应用，将 AI 助手带到您计算机上的每个应用程序中。从[最新版本](https://github.com/MODSetter/Nowing/releases/latest)下载。

桌面应用包含以下强大功能：

- **General Assist** — 通过全局快捷键从任何应用程序即时启动 Nowing。
- **Quick Assist** — 在任何位置选中文本，然后让 AI 解释、改写或对其执行操作。
- **Extreme Assist** — 在任何应用中输入时，获得基于您知识库的内联写作建议。
- **Watch Local Folder** — 监视本地文件夹，自动将文件更改同步到您的知识库。**Pro tip：** 将其指向您的 Obsidian vault，让笔记在 Nowing 中随时可搜索。
...
4. 您的团队现在可以实时聊天。
   ...
   <p align="center"><img src="nowing_web/public/homepage/hero_realtime/RealTimeChatGif.gif" alt="实时聊天" /></p>
...
**Nowing 正在积极开发中。** 虽然它还未达到生产就绪状态，但您可以帮助我们加快进度。
...
**路线图讨论：** [Nowing 2026 Roadmap](https://github.com/MODSetter/Nowing/discussions/565)
