...
Nowing (the agent retrieves; we mostly just instruct it on
...
def build_nowing_prompt(question: str) -> str:
    """Prompt for the Nowing arm (retrieval-augmented)."""
...
__all__ = ["build_bare_prompt", "build_nowing_prompt"]
