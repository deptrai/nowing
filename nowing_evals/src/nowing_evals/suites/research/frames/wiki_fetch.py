...
want Nowing to chunk + embed. We prepend ``# <Title>\n\n`` so the
markdown has a visible H1 (helps Nowing's chunker preserve doc
...
USER_AGENT = (
    "Nowing-Evals/0.1 (https://github.com/nowing/Nowing; "
