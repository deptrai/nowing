...
Why CRAG demonstrates Nowing more clearly than FRAMES
--------------------------------------------------------
FRAMES tested Nowing vs. *no retrieval at all* — a fair "naive
...
* ``nowing``     — POST ``/api/v1/new_chat`` with retrieval scoped
  to the question's 5 ingested pages (``mentioned_document_ids``).

So the headline becomes "Nowing vs. context-stuffed long-context
