...
* ``nowing_backend/app/routes/search_spaces_routes.py:116`` (POST create)
* ``nowing_backend/app/routes/search_spaces_routes.py:234`` (GET by id)
* ``nowing_backend/app/routes/search_spaces_routes.py:422`` (DELETE soft-delete)
* ``nowing_backend/app/routes/model_connections_routes.py`` (GET/PUT model roles)
* ``nowing_backend/app/schemas/search_space.py:14`` (SearchSpaceCreate body)
