...
``nowing_backend/app/etl_pipeline/parsers/azure_doc_intelligence.py``
...
async def parse_with_azure_di(
    ...
    *,
    ...
    ``AZURE_DI_KEY`` env vars (set in ``nowing_evals/.env``).
    ...
    # Lazy imports — nowing_evals shouldn't pay the azure-sdk
